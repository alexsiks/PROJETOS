    ...
    public partial class Form1_atualizar : Form
    {
        ...
        private void button1_procurar_Click(object sender, EventArgs e)
        {
            ...
            string sql =$"  update pessoa set nome = '{textBox2_nome.Text}'," +
                ...
                $" sexo = '{textBox1_SEXO.Text}',datanascimento = '{dateTimePicker1_nascimento.Text}',ATUALIZACAODADOS = GETDATE(), endereco = '{textBox_endereco.Text}'  where idpessoa = {textBox1_idpessoa_atualizar.Text}";
        ...
        private void button1_carregar_Click(object sender, EventArgs e)
        {
            ...
            string sql = "SELECT idpessoa,nome,sobrenome,sexo,datanascimento,endereco FROM pessoa WHERE idpessoa= @Idpessoa ";
            ...
            {
                MessageBox.Show("VERIFIQUE AS INFORMAÇÕES REFERENTE AO ID: ","ERRO DE EXECUÇÃO DE ATUALIZAÇÃO",MessageBoxButtons.OK );
            }
            finally
            {
                con.Close();
        ...
        private void textBox2_sobrenome_TextChanged(object sender, EventArgs e)
        {
